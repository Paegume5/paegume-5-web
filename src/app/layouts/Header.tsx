...
const Header = () => {
  ...
  return (
    <div
      className="relative flex flex-col w-full h-screen overflow-x-hidden text-white bg-center bg-cover"
    >
      ...
      <div className="absolute flex flex-col items-center justify-center flex-grow w-full h-full gap-10 px-4 pt-28 bg-gradient-default">
        <div
          className="flex flex-col items-center justify-center text-center select-none text-heading lg:text-4xl md:text-heading-md"
        >
