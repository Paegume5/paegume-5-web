...
const HowToHelp = () => {
  return (
    <div className="flex items-center justify-center px-8 md:px-2 mx-auto lg:flex-col">
      <div className="flex flex-col gap-12 justify-center w-full h-full p-12 md:p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <HelpCard header="Donation" iconSrc="/svg/icons/money.svg">
            We kindly request your support through donations. Whether it is a
            monetary contribution or an in-kind donation, every contribution is
            greatly appreciated.
          </HelpCard>
          <HelpCard header="Awareness" iconSrc="/svg/icons/awareness.svg">
          ...
          <HelpCard header="Volunteering" iconSrc="/svg/icons/volunteer.svg">
          ...
          <HelpCard header="Hosting an event" iconSrc="/svg/icons/event.svg">
